...
**πέντε έτοιμες ενότητες** (Κεφ. 1 · **Α.1** «Τα δημογραφικά δεδομένα» ·
**Α.2** «Οι παραγωγικές δυνάμεις… και η «Μεγάλη Ιδέα»» · **Γ.2** · **Γ.3** ·
**Γ.4**) από τις 105 του χάρτη. Νέα ενότητα = ένα νέο
...
- **Τα τρία τυπογραφικά του βιβλίου μένουν** («μεγάλο δάνεια» · «Το ποσά αυτά» ·
  ...
  (`istoria-voithima.source.txt` Γ.4 · `-g3` · `-g2` · `-a1` · `-a2`). ⚠️ Η Α.1 ζει σε
  ΑΛΛΗ σελίδα του βιβλίου (`index1_2`): το κεφ. 1 είναι μοιρασμένο σε τρία
  αρχεία, ένα ανά τμήμα Α/Β/Γ.
