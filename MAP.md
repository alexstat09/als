...
**επτά έτοιμες ενότητες** (Κεφ. 1 · **Α.1** «Τα δημογραφικά δεδομένα» ·
**Α.2** «Οι παραγωγικές δυνάμεις… και η «Μεγάλη Ιδέα»» · **Β.1** «Το εμπόριο» ·
**Β.2** «Η εμπορική ναυτιλία» · **Γ.2** · **Γ.3** · **Γ.4**) από τις 105 του χάρτη. Νέα ενότητα = ένα νέο
...
δωρεάν το `tools/istoria-unit.js` (skill `istoria-enotita`).
...
- **Τα τρία τυπογραφικά του βιβλίου μένουν** («μεγάλο δάνεια» · «Το ποσά αυτά» ·
  ...
  (`istoria-voithima.source.txt` Γ.4 · `-g3` · `-g2` · `-a1` · `-a2` · `-b1` · `-b2`). ⚠️ Η Α.1 ζει σε
