...
**Study** — `latinika.html` (Λατινικά, **als-v516 · + `latinika-eisagogi.html` /
`latinika-lectio16.html` / `latinika-lectio17.html` / `latinika-lectio18.html`**), `tonos.html` (Τονισμός,
...
- ⛔ **Τα `lectio16:v1` / `lectio17_known_v1` / `lectio18_known_v1` ΔΕΝ
  συγχρονίζονται, επίτηδες:**
