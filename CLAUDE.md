...
2. **Bump `CACHE` in `sw.js:15` on every deploy.** Currently `als-v471`. Never
   move it backwards.
...
**2026-08-11 — `als-v471` — ΤΟ ΣΥΜΒΟΛΑΙΟ: Η ΠΡΩΤΗ ΣΕΛΙΔΑ ΜΕΛΕΤΗΣ ΠΟΥ ΑΝΑΦΕΡΕΙ
...
**ΜΟΝΟ η Φάση 0 του `docs/HOMEWORK_SPEC_V2.md`**, όχι οι φάσεις 1–7.
...
- Οι φάσεις 1–7 του `docs/HOMEWORK_SPEC_V2.md` είναι όλες ανοιχτές, μαζί με τα
...
### 📋 `docs/HOMEWORK_SPEC_V2.md` — ⭐ Η ΤΡΕΧΟΥΣΑ ΑΛΗΘΕΙΑ, ΔΙΑΒΑΣΕ ΤΟ ΠΡΩΤΟ
...
for f in tests/*.js; do node "$f"; done   # 41 files; 40 suites + 1 tool.
