...
2. **Bump `CACHE` in `sw.js:15` on every deploy.** Currently `als-v489`. Never
   move it backwards.
...
**ΕΝΝΕΑ units as of als-v488 — 111 σημεία, 371 στοιχεία, 8.321 βεβαιώσεις** — and
...
**2026-08-17 — `als-v489` — ΜΙΑ ΣΕΛΙΔΑ ΙΣΤΟΡΙΑΣ, ΚΑΙ ΕΙΝΑΙ Ο ΠΛΑΓΙΟΤΙΤΛΟΣ**
