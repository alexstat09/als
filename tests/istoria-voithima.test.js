...
if (B9) {
  ...
  is('  ⭐⭐ Β.9 · η ΜΟΝΗ ενότητα του τμήματος Β με ΜΗΔΕΝ τυπογραφικά οποιουδήποτε είδους',
     bSic.filter(c => c.sic.length === 0).map(c => 'Β.' + c.num).join(','), 'Β.9');
...
ok('  ⭐ και δείχνουν όλες στη Β.9, όπου ο πίνακας είναι τυπωμένος στο βιβλίο',
   (PAGE.match(/ζει στο σχεδιάγραμμα της (<b>)?Β\.9/g) || []).length === 4);
