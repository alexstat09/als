...
(function () {
  ...
  var ITEMS = [
    ...
    ['Insight Engine', 'insights.html', 'Life'], ['Αρχαία', 'arxaia.html', 'Study'], ['Λατινικά', 'latinika.html', 'Study'], ['Τονισμός', 'tonos.html', 'Study'], ['Ιστορία', 'istoria.html', 'Study'], ['Η Χρονιά', 'study.html', 'Study'], ['Το χρέος', 'homework.html', 'Study'], ['Εργασίες', 'homework.html', 'Study'],
