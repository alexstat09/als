...
(function () {
  ...
  var STORES = [
    ...
    /* ⭐⭐ als-v495: Η ΕΚΘΕΣΗ ΑΠΟΚΤΑ ΣΚΑΛΑ. Ήταν το 30% με ΜΗΔΕΝ δεδομένα —
       ισόπαλη με τα Αρχαία και η μόνη γραμμή του School Studies που δεν
       μπορούσε να πει τίποτα. Η μονάδα είναι το ΛΗΜΜΑ του λεξικού
       (`words`), η ακρίβεια ζει ΑΝΑ ΣΤΟΙΧΕΙΟ (`els`), ίδιο σχήμα με το
       `ist:v1`.
       ⚠️ ΤΟ `els` ΓΡΑΦΕΤΑΙ ΜΟΝΟ ΑΠΟ ΑΒΟΗΘΗΤΗ ΑΝΑΚΛΗΣΗ — τα δύο περάσματα με
       νήματα ΔΕΝ αγγίζουν ούτε τη σκάλα ούτε την ακρίβεια. Ένα χρέος
       μετρημένο με βοήθεια είναι χρέος που λέει ψέματα (σταθερή αρχή 23:
       το χρέος μετριέται όπως το μετράει η σελίδα που το κατέχει). */
    { key: 'ekt:v1', page: 'ekthesi.html', subject: 'ekthesi', label: 'Έκθεση · λεξιλόγιο',
      kind: 'units', ladder: 'words', acc: 'els',   weight: 30, deep: null }
  ];
